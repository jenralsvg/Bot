...
*/
const A187 = '👾lentBot👾'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/maslent11'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('message-status-update', json =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @maslent11`)
})

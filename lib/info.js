exports.info = (id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, telegram, youtube, kapanbotaktif, grupch1, grupch2) => {
	return `🐼 ${A187} 🐼
...
▶️TOLONG BANTU SUBREK,LIKE & SHERE YT KilL4Life◀️
💵GUNAKAN LINK !donasi untuk berdonasi💵

INFO BOT! :
🔱 *AUTHOR*: Jenral Svg
🔱 *GITHUB*: https://github.com/jenralsvg/Bot
🔱 *INSTAGRAM*: ${instagram}
🔱 *YOUTUBE*: ${youtube}
🔱 *TELEGRAM* : ${telegram}
